...
public final class KeyboardTheme {
    ...
    public static final int THEME_ID_EINK = 7;
    public static final int DEFAULT_THEME_ID = THEME_ID_EINK;
    ...
    static final KeyboardTheme[] KEYBOARD_THEMES = {
        ...
        new KeyboardTheme(THEME_ID_EINK, "EInk", R.style.KeyboardTheme_EInk, false),
    };
